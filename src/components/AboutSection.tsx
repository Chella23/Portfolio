          ...
          {highlights.map((highlight, index) => (
            <Card key={index} className="text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1 animate-fade-in border-0 bg-gradient-to-br from-card to-card/80 backdrop-blur-sm" style={{animationDelay: `${index * 200}ms`}}>
              <CardContent className="p-6">
                ...
                <div className="text-2xl sm:text-3xl font-bold text-primary mb-1">{highlight.value}</div>
          ...
          <div className="space-y-6 animate-fade-in delay-300">
            <div className="relative">
              ...
              <div className="absolute bottom-4 left-4 text-white">
                <div className="text-sm font-medium">My Development Environment</div>
              </div>
            </div>
          ...
          <div className="animate-fade-in delay-500">
            ...
            <div className="space-y-6">
              {education.map((edu, index) => (
                <Card key={index} className="border-l-4 border-l-primary hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-r from-card to-card/80 backdrop-blur-sm" style={{animationDelay: `${(index + 3) * 200}ms`}}>
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <span className="text-sm font-medium text-primary bg-primary/10 px-2 py-1 rounded-full">{edu.year}</span>
                        </div>
